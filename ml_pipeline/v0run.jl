...
# ╔═╡ 3f49e94a-54a0-4a77-acc2-b86b2d71bcc5
begin
	using CSV
	using DataFrames
	using TextAnalysis
...
# ╔═╡ 35971dcc-edf7-44ae-99da-ad433ad59704
function cosine_similarity(vec1, vec2)
    return dot(vec1, vec2) / (norm(vec1) * norm(vec2))
end

# ╔═╡ 3bd5c36b-c243-4223-b7b3-bda3230e1e8a
begin
...
begin
	...
	idf=load("./trainings/idf.jld2")["idf"]
	training_embeddings=load("./trainings/training_embeddings.jld2")["training_embeddings"]
end

# ╔═╡ 4a5e6c36-e925-11ef-0721-6102f0ec10ab
...
# ╔═╡ 0f9ff449-0735-4ffa-8df3-d6442bc8c6ec
...
begin
	...
	begin
		CSV.write("./vec_output/source_tasks_output.csv", out_g_fin)
		CSV.write("./vec_output/stc_vec_output.csv", out_stc_vec)
		CSV.write("./vec_output/disc_vec_output.csv", out_disc_vec)
...
manifest_format = "2.0"
project_hash = "a74b4d9ab34fcc1e5e4eaf11e61d033563bee7b4"
