...
function task_stef1(df)
	...
	new_corpus = Corpus(StringDocument.(new_sentences))
	update_lexicon!(new_corpus)
	new_dtm = DocumentTermMatrix(new_corpus, dtm.terms)
...
task_clusters=incremental_clustering(mltask)
...
manifest_format = "2.0"
project_hash = "d2a217cfb2c65df31f44f87dee0584847336622c"
