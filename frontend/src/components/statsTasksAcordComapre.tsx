...
const TaskListCompareScreen: React.FC<TaskListProps> = ({ tasks }) => {
            ...
            <ScrollArea h='85vh' scrollbarSize={0} scrollHideDelay={0}>
                ...
                >
                    {filteredTasks.map((task) => (
                        <Accordion.Item key={task.package_number} value={task.package_number}>
                            <Accordion.Control
                                style={{
                                    paddingLeft: 10,
                                    paddingRight: 10,
                                    background: openedAccordion === task.package_number
                                        ? "linear-gradient(90deg,rgb(78, 95, 228), #4364F7)"
                                        : "transparent",
                                    color: openedAccordion === task.package_number ? "#fff" : "#000",
                                    borderRadius: "10px",
                                    height: 65,
                                }}
                            >
                                    ...
                                    <Grid.Col span={3}>
                                        <Card bg="#e7e6e8">
                                            <Group justify="space-between">
                                                ...
                                                <Text fw={700} fz="md" c="#05800d">{task.accuracy_avg_mh} %</Text>
                                            </Group>
                                        </Card>
                                    </Grid.Col>
                                    <Grid.Col span={3}>
                                        <Card bg="#e7e6e8">
                                            <Group justify="space-between">
                                                <Text size="sm">Accuracy</Text>
                                                <Text fw={600} fz="md" c="#05800d">{task.accuracy_total_billable_value_usd_tasks.toFixed(2)} %</Text>
                                            </Group>
                                        </Card>
                                    </Grid.Col>
                                    <Grid.Col span={3}>
                                        <Card bg="#e7e6e8">
                                            <Group justify="space-between">
                                                <Text size="sm">Accuracy</Text>
                                                <Text fw={600} fz="md" c="#05800d">{task.accuracy_avg_mh_findings} %</Text>
                                            </Group>
                                        </Card>
                                    </Grid.Col>
                                    <Grid.Col span={3}>
                                        <Card bg="#e7e6e8">
                                            <Group justify="space-between">
                                                <Text size="sm">Accuracy</Text>
                                                <Text fw={600} fz="md" c="#05800d">{task.accuracy_total_billable_value_usd_findings.toFixed(2)} %</Text>
                                            </Group>
                                        </Card>
                                    </Grid.Col>
                                </Grid>
